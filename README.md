...
* [QT](https://github.com/moonlight-stream/moonlight-qt) ⭐ 18,711 | 🐛 561 | 🌐 C++ | 📅 2026-09-20 - Official QT client.
* [Android](https://github.com/moonlight-stream/moonlight-android) ⭐ 7,145 | 🐛 395 | 🌐 C | 📅 2026-09-12 - Official Android client.
...
* [Nintendo Switch](https://github.com/XITRIX/Moonlight-Switch) ⭐ 1,639 | 🐛 89 | 🌐 C | 📅 2026-07-26 - Moonlight client for Nintendo Switch.
...
* [Samsung Tizen TV](https://github.com/brightcraft/moonlight-tizen) ⭐ 275 | 🐛 10 | 🌐 C | 📅 2026-09-15 - Moonlight client for Samsung Tizen TV.
...
* [Playnite](https://github.com/JosefNemec/Playnite) ⭐ 14,041 | 🐛 714 | 🌐 C# | 📅 2026-09-13 - Video game library manager with support for wide range of 3rd party libraries and game emulation support, providing one unified interface for your games.
* [Steam](https://store.steampowered.com) - The ultimate destination for playing, discussing, and creating games.

## 💻 Virtual Displays

* [Virtual-Display-Driver](https://github.com/itsmikethetech/Virtual-Display-Driver) ⭐ 10,162 | 🐛 206 | 🌐 C++ | 📅 2026-09-19 - Add virtual monitors to your Windows 10/11 device! Works with VR, OBS, Sunshine, and/or any desktop sharing software.
* [parsec-vdd](https://github.com/nomi-san/parsec-vdd) ⭐ 5,555 | 🐛 7 | 🌐 C# | 📅 2026-05-15 - Standalone Parsec Virtual Display.
...
* [Virtual HID Driver](https://github.com/LizardByte/libvirtualhid) ⭐ 59 | 🐛 17 | 🌐 C++ | 📅 2026-09-21 - User-mode virtual gamepads for Windows. Adds more gamepad types to Windows, such as Xbox One|Series, DualSense, Nintendo Switch Pro, and more to come in the future.
