...
* [QT](https://github.com/moonlight-stream/moonlight-qt) ⭐ 18,306 | 🐛 552 | 🌐 C++ | 📅 2026-08-17 - Official QT client.
* [Android](https://github.com/moonlight-stream/moonlight-android) ⭐ 6,972 | 🐛 397 | 🌐 C | 📅 2026-08-11 - Official Android client.
...
* [Nintendo Switch](https://github.com/XITRIX/Moonlight-Switch) ⭐ 1,605 | 🐛 89 | 🌐 C | 📅 2026-07-26 - Moonlight client for Nintendo Switch.
* [LG webOS TV](https://github.com/mariotaku/moonlight-tv) ⭐ 1,456 | 🐛 73 | 🌐 C | 📅 2026-08-17 - Moonlight client for LG webOS TV.
...
* [Samsung Tizen TV](https://github.com/brightcraft/moonlight-tizen) ⭐ 242 | 🐛 16 | 🌐 C | 📅 2026-08-15 - Moonlight client for Samsung Tizen TV.
...
* [Playnite](https://github.com/JosefNemec/Playnite) ⭐ 13,773 | 🐛 706 | 🌐 C# | 📅 2026-08-17 - Video game library manager with support for wide range of 3rd party libraries and game emulation support, providing one unified interface for your games.
* [Steam](https://store.steampowered.com) - The ultimate destination for playing, discussing, and creating games.

## 💻 Virtual Displays

* [Virtual-Display-Driver](https://github.com/itsmikethetech/Virtual-Display-Driver) ⭐ 9,893 | 🐛 200 | 🌐 C++ | 📅 2026-06-22 - Add virtual monitors to your Windows 10/11 device! Works with VR, OBS, Sunshine, and/or any desktop sharing software.
* [parsec-vdd](https://github.com/nomi-san/parsec-vdd) ⭐ 5,492 | 🐛 7 | 🌐 C# | 📅 2026-05-15 - Standalone Parsec Virtual Display.
...
* [virtual-display-rs](https://github.com/MolotovCherry/virtual-display-rs) ⭐ 889 | 🐛 19 | 🌐 Rust | 📅 2025-03-03 - A Windows virtual display driver to add multiple virtual monitors to your PC! For Win10+. Works with VR, obs, streaming software, etc.
